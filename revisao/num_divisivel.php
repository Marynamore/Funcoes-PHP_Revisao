...
<head>
    ...
    <title>Crie uma função em PHP que receba um valor e informe se ele é divisível por 10, por 5, por 2 ao mesmo tempo ou se não é divisível por nenhum destes.</title>
</head>
